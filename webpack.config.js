module.exports = {
    ...
    module : {
        rules: [
            ...
            {test: /.css$/, use: ['style-loader', 'css-loader',"postcss-loader"]},/*解析css, 并把css添加到html的style标签里*/
            ...
            {test: /.less$/, use: ['style-loader', 'css-loader', 'less-loader',"postcss-loader"]}/*解析less, 把less解析成浏览器可以识别的css语言*/
        ]
    },
    // mode:'development'
}